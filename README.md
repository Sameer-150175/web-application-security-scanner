...
Web Application Security Scanner is a recruiter-friendly cybersecurity portfolio project built with Python, Flask, Requests, passive security checks. It provides a dashboard, REST API, persistence, tests, Docker support, and documentation that can be pushed as an individual GitHub repository.
